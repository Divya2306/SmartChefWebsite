                ...
                <div className="w-2/3 h-full flex items-center justify-center">
                    <div className="p-10 gap-6 bg-[#fff8f2] shadow-[--dark] shadow-lg rounded-xl flex flex-col items-center justify-center">
                        ...
                        <div className="flex items-center w-full justify-between">
                            <button onClick={submit} type="submit" className="px-6 py-2 text-[--light] bg-color2 rounded-md hoverr">Sign Up</button>
                            <Link to="/" className="text-color underline">Login</Link>
                        </div>
                    </div>
                </div>
            </div>
